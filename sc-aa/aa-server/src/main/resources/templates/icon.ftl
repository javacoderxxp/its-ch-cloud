...
<script src="${rc.contextPath}/assets/plugins/vue/vue.min.js"></script>
<script src="${rc.contextPath}/assets/plugins/jQuery/jquery-2.2.3.min.js"></script>
<script src="${rc.contextPath}/assets/plugins/moment/moment.min.js"></script>
<script src="${rc.contextPath}/assets/plugins/fullcalendar/fullcalendar.min.js"></script>
<script src="${rc.contextPath}/assets/js/domain/qw/dutyScheduleCalendar.js"></script>
</body>
</html>